...
<img height="150" src="./github-stats.svg" alt="GitHub stats: header only" />
<img height="150" src="./languages.svg" alt="Most-used languages" />

<br/>

<img src="./contributions.svg" alt="Compact half-year contribution calendar" width="70%"/>

<sub>Generated by a GitHub Action in this repo (<code>.github/workflows/metrics.yml</code>) — three lean, separate cards instead of one dense report; recomputed on every run.</sub>
