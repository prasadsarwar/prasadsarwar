...
<img src="./github-metrics.svg" alt="GitHub Metrics: recent activity trend and most-used languages" width="100%"/>

<sub>Generated by a GitHub Action in this repo (<code>.github/workflows/metrics.yml</code>) — activity chart and languages are recomputed on every run, so nothing here depends on a third-party server's uptime.</sub>
